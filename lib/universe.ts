...
export const UNIVERSE: StockMeta[] = [
  ...
  // 核心池 — 半导/设备/存储/服务器
  { symbol: "AMAT", name: "Applied Materials", sector: "Technology", typicalOptionsVolume: "High", notes: "核心池" },
  { symbol: "COHR", name: "Coherent", sector: "Technology", typicalOptionsVolume: "Medium", notes: "核心池" },
  { symbol: "MU", name: "Micron", sector: "Technology", typicalOptionsVolume: "High", notes: "核心池" },
  { symbol: "LRCX", name: "Lam Research", sector: "Technology", typicalOptionsVolume: "High", notes: "核心池" },
  { symbol: "KLAC", name: "KLA", sector: "Technology", typicalOptionsVolume: "High", notes: "核心池" },
  { symbol: "ARM", name: "Arm Holdings", sector: "Technology", typicalOptionsVolume: "High", notes: "核心池" },
  { symbol: "MRVL", name: "Marvell", sector: "Technology", typicalOptionsVolume: "High", notes: "核心池" },
  { symbol: "WDC", name: "Western Digital", sector: "Technology", typicalOptionsVolume: "High", notes: "核心池" },
  { symbol: "STX", name: "Seagate Technology", sector: "Technology", typicalOptionsVolume: "High", notes: "核心池" },
  { symbol: "TER", name: "Teradyne", sector: "Technology", typicalOptionsVolume: "High", notes: "核心池" },
  { symbol: "INTC", name: "Intel", sector: "Technology", typicalOptionsVolume: "High", notes: "核心池" },
  { symbol: "DELL", name: "Dell Technologies", sector: "Technology", typicalOptionsVolume: "High", notes: "核心池" },

  { symbol: "AVGO", name: "Broadcom", sector: "Technology", typicalOptionsVolume: "High", notes: "核心池" },
  { symbol: "TSM", name: "TSMC", sector: "Technology", typicalOptionsVolume: "High", notes: "核心池" },
